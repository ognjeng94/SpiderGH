...
namespace SpiderGH
{
    public class SDStar : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the SDStar class.
        /// </summary>
        public SDStar()
          : base("SD Star", "SD Star",
              "Subdivision Star",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Sides", "N", "Number of sides", GH_ParamAccess.item, 5);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Polyline poly;
            bool testPoly = S_Solver.ConstructStar(plane, sides, r1, r2, out poly);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return SpiderGH.Properties.Resources._04_SDStar;
            }
        }
        ...
        {
            get { return new Guid("11C3168F-277E-49C6-BC6D-A344B6465CFD"); }
        }
    }
}